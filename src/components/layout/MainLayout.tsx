  ...
  return (
    <PageBackground>
      <div className="flex min-h-screen">
        {/* Sidebar for desktop */}
        <aside className="hidden md:flex flex-col w-64 border-r border-white/10 bg-[#0A0E2E]/80 backdrop-blur-lg z-10">
          <div className="flex items-center gap-3 py-6 px-4 border-b border-white/10">
            ...
            <h1 className="text-xl font-semibold tracking-tight bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent animate-text-gradient">
              BioPay Connect
            </h1>
          </div>
        ...
        {/* Main content */}
        <main className="flex-1 overflow-auto pt-0 md:pt-0 mt-12 md:mt-0 bg-transparent">
